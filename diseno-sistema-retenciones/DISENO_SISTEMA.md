...
**Verificación contra datos reales de Fiberhome:** para `COD_REGIMEN=94` (Locaciones de Obra y/o Servicios), inscripto, la tabla da alícuota 2% y mínimo no imponible $67.170. En `Retenciones_Ganancias_Practicadas_2026.xlsx`, la fila de Proveedor E tiene Monto Neto $1.794.000 y Base Imponible $1.726.830 → 1.794.000 − 67.170 = 1.726.830, exacto. El código 78 ("Enajenación de bienes muebles y bienes de cambio") que aparece en la hoja `FC C` también coincide con el mismo código en la tabla de AFIP. Es la misma codificación que Fiberhome ya usa hoy.
